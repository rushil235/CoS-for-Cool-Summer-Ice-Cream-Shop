...
<head>
    ...
    async function loadPromoCodes() {
        try {
            const response = await fetch('promo_codes.php?action=list');
        ...
        async function addPromo() {
            ...
            try {
                const response = await fetch('promo_codes.php?action=add', {
                    method: 'POST',
        ...
        async function editPromo(id) {
            ...
            try {
                const response = await fetch('promo_codes.php?action=update', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
        ...
        async function deletePromo(id) {
            ...
            try {
                const response = await fetch(`promo_codes.php?action=delete&id=${id}`, { method: 'DELETE' });
                const result = await response.json();
        ...
        async function toggleStatus(id, currentStatus) {
            ...
            try {
                const response = await fetch('promo_codes.php?action=toggle_status', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
